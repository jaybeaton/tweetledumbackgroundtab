	...
	if (details.reason === 'update') {
		...
		switch (details.previousVersion) {
			case "0.1":
				...
				url = 'data:text/html,<h1>TweetledumBackgroundTab Updated!</h1><p>Tweetledum Background Tab has been updated.  Please check the <a href="#">extension page</a> for more information.</p>';
				break;
		}
		if (url) {
			chrome.tabs.create({
